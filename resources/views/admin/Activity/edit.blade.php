                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div>
                                                    @if($activity->web_icon)
                                                        <img src="{{ asset('storage/' . $activity->web_icon) }}" alt="Web Icon" class="img-thumbnail" style="max-height: 100px;">
                                                    @else
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div>
                                                    @if($activity->mobile_icon)
                                                        <img src="{{ asset('storage/' . $activity->mobile_icon) }}" alt="Mobile Icon" class="img-thumbnail" style="max-height: 100px;">
                                                    @else
