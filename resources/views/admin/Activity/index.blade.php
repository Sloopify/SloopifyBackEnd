            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                            ...
                            <form method="post" action="{{ route('admin.activity.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label" for="basic-icon-default-name">Activity Name</label>
                    ...
                    <div class="card">
                        ...
                        <h5 class="card-header">Activity Table</h5>

                        <!-- Filter Section -->
                        <div class="card-body" style="max-height: 300px; overflow-y: auto;">
                            <form method="GET" action="{{ route('admin.activity.index') }}" class="mb-4">
                                <div class="row g-3">
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-1 d-flex align-items-end">
                                        ...
                                        <a href="{{ route('admin.activity.index') }}" class="btn btn-secondary" style="height: 48px;padding-top: 12px">Reset</a>
                                    </div>
                                    <div class="row g-3">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="exportDropdown">
                                                <li><a class="dropdown-item" href="{{ route('admin.activity.export', request()->all()) }}">Export to CSV</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="table-responsive text-nowrap">
                            <table class="table">
                                ...
                                @forelse($activities as $index => $activity)
                                    <tr>
                                        <th scope="row">{{ ($activities->currentPage() - 1) * $activities->perPage() + $index + 1 }}</th>
                                        <td>{{ $activity->name }}</td>
                                        ...
                                        <td>
                                            @if($activity->web_icon)
                                                <img src="{{ asset('storage/' . $activity->web_icon) }}"
                                        ...
                                        <td>
                                            @if($activity->mobile_icon)
                                                <img src="{{ asset('storage/' . $activity->mobile_icon) }}"
                                                     style="width: 40px; height: 40px;" class="rounded">
                                            @else
                                                <span class="text-muted">No Icon</span>
                                            @endif
                                        ...
                                        <td>{{ $activity->updated_at->format('Y-m-d') }}</td>
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="{{ route('admin.activity.edit', $activity->id) }}">
                                                        <i class="bx bx-edit-alt me-1"></i> Edit
                                                    </a>
                                                    <form method="post" action="{{ route('admin.activity.delete', $activity->id) }}">
                                                        @csrf
                                                        @method('delete')
                                                        <button class="dropdown-item btn" type="submit" onclick="return confirm('Are you sure you want to delete this activity?')">
                        ...
                        <div class="card-footer">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    <form method="GET" action="{{ route('admin.activity.index') }}" class="d-inline-flex align-items-center">
