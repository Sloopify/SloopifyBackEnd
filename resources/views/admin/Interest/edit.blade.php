                        ...
                        <div class="col-12">
                            <div class="card mb-4">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="{{ route('admin.interest.index') }}" class="btn btn-secondary">Back</a>
                                </div>
                                <div class="card-body">
                                    ...
                                    <form method="post" action="{{ route('admin.interest.update', $interest->id) }}" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                                ...
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    >
                                                        ...
                                                        @foreach($categories as $category)
                                                            <option value="{{ $category }}" {{ old('category', $interest->category) === $category ? 'selected' : '' }}>
                                                                {{ $category }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    >
                                                        ...
                                                        <option value="active" {{ old('status', $interest->status) === 'active' ? 'selected' : '' }}>Active</option>
                                                        <option value="inactive" {{ old('status', $interest->status) === 'inactive' ? 'selected' : '' }}>Inactive</option>
                                                    </select>
                                                </div>
                                                @error('status')
                                                <div class="text-danger">{{ $message }}</div>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div>
                                                    @if($interest->web_icon)
                                                        <img src="{{ asset('storage/' . $interest->web_icon) }}" alt="Web Icon" class="img-thumbnail" style="max-height: 100px;">
                                                    @else
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div>
                                                    @if($interest->mobile_icon)
                                                        <img src="{{ asset('storage/' . $interest->mobile_icon) }}" alt="Mobile Icon" class="img-thumbnail" style="max-height: 100px;">
                                                    @else
